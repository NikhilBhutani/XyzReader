...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        toolbar =(Toolbar)mRootView.findViewById(R.id.detailstoolbar);
        collapsingToolbarLayout = (CollapsingToolbarLayout)mRootView.findViewById(R.id.collpasingToobar);
